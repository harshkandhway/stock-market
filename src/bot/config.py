...
PAPER_TRADING_DAILY_SUMMARY_TIME = os.getenv('PAPER_TRADING_DAILY_SUMMARY_TIME', '16:00')
PAPER_TRADING_WEEKLY_SUMMARY_TIME = os.getenv('PAPER_TRADING_WEEKLY_SUMMARY_TIME', '18:00')
PAPER_TRADING_POSITION_REBALANCE_TIME = os.getenv('PAPER_TRADING_POSITION_REBALANCE_TIME', '11:00')

# Price tolerance
PAPER_TRADING_ENTRY_PRICE_TOLERANCE = float(os.getenv('PAPER_TRADING_ENTRY_PRICE_TOLERANCE', '3.0'))
